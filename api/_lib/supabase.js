...
// ไอคอนต่อกิจกรรม (ใช้ในข้อความ Telegram)
export const ACT_ICON = {
  'พักเบรค': '☕️', 'สูบบุหรี่': '🚬', 'เข้าห้องน้ำ': '🚻',
  'ซื้อ/กินข้าว': '🍽', 'ช่วยงานบริษัท': '🤝',
};
// limit (นาที) ต่อกิจกรรม — break 120, อื่นๆ 20, assist ไม่จำกัด
export const ACT_LIMIT = {
  'พักเบรค': 120, 'สูบบุหรี่': 20, 'เข้าห้องน้ำ': 20, 'ซื้อ/กินข้าว': 20, 'ช่วยงานบริษัท': 0,
};
